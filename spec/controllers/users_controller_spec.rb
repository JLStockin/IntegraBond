...
describe UsersController do
		...
		describe "for signed-in users" do
			...
			it "should have an element for each user" do
				...
				@users[0..2].each do |user|
					...
					response.should have_selector("li", :content => user.last_name)
				end
			end
	...
	describe "GET 'new'" do
		...
		it "should deny access to 'new' for signed-in users" do
			@user = test_sign_in(FactoryGirl.create(:user))
			get :new
	...
	describe "POST 'create'" do
		...
		it "should deny access to signed-in users" do
			@attr = {	:first_name => "",
						:last_name => "",
						:email => "", :password => "",
		...
		describe "success" do
			...
			it "should have a welcome message" do
				post :create, :user => @attr
				pattern = %r(Welcome to #{SITE_NAME})i
				flash[:success].should =~pattern
			end
	...
	describe "PUT 'update'" do
		...
		describe "success" do
			...
			before(:each) do
				@attr = {	:first_name => "New", :last_name => "Name",
